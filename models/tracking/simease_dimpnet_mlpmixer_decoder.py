...
class Siamese_DiMPnet(nn.Module):
    ...
    def forward(self, train_imgs, test_imgs, train_bb, test_proposals, *args, **kwargs):
        ...
        train_feat, train_rec_pair = self.extract_simease_backbone_feat(train_imgs)
        test_feat, test_rec_pair = self.extract_simease_backbone_feat(test_imgs)

        rec_pair = train_rec_pair+test_rec_pair
    ...
    def extract_simease_backbone_feat(self,input_images):
        ...
        # rec_pair = [[rgb_feats['layer3'],rec_rgb_feats], [tir_feats['layer3'],rec_tir_feats]]
        rec_pair= []
