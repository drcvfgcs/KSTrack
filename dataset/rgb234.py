...
class RGB234(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        super().__init__('RGB234', root, image_loader)
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        img_name = int(self.seq_img_dict[seq][frame_id].split('.')[0][:-1])
        ...
        for i in range(0,5):
            ...
            if os.path.exists(img_tir_path):
                break
